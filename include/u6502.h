...
typedef void     (*U6502_WriteCallback)(U6502 *mpu, uint16_t address, uint8_t data);
typedef uint16_t (*U6502_CallCallback)(U6502 *mpu, uint16_t address, uint16_t source);

enum {
  U6502_NMIVector= 0xfffa,  U6502_NMIVectorLSB= 0xfffa,  U6502_NMIVectorMSB= 0xfffb,
  U6502_RSTVector= 0xfffc,  U6502_RSTVectorLSB= 0xfffc,  U6502_RSTVectorMSB= 0xfffd,
  U6502_IRQVector= 0xfffe,  U6502_IRQVectorLSB= 0xfffe,  U6502_IRQVectorMSB= 0xffff
};
...
extern U6502 *U6502_new(U6502_Registers *registers, U6502_Callbacks callbacks, void* userdata);
...
#define U6502_setVector(MPU, VEC, ADDR)						\
  ( ( ((MPU)->callbacks.write((MPU), U6502_##VEC##VectorLSB, ((uint8_t)(ADDR)) & 0xff)) )	\
    , ((MPU)->callbacks.write((MPU), U6502_##VEC##VectorMSB, (uint8_t)((ADDR) >> 8))) )
